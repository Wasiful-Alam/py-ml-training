...
println("Maximum erro: $(maximum(abs.(analyticSolution1 - analyticSolution2)))")
...
scatter!(xGrid, mcEstimates, c=:red, ms=6, msw=0, shape=:xcross,
    label="MontyCarlo Estimate", xlims=(0, 50), ylims=(0, 1),
    xlabel="Number of  people in room",
    ylabel="Probability of borthday match",
    legend=:topleft
)
